...
public class PlayerMovement : MonoBehaviour
{
    ...
    [Tooltip("Pannel That Causes The Fade To Black")] public Image FadeToBlackImage;
    ...
    void NormalMovement()
    {
        ...
        if (FadeToBlackImage.color.a < 1)
        {
            FadeToBlack(PlayerChargeLossSpeed);
        }
    ...
    void DOPMovement()
    {
        ...
        if (PlayerCharge > 0)
        {
            FadeToTransparant(PlayerChargeRechargeSpeed);
        }
    }
    ...
    private void FadeToBlack(float ChargeChange)
    {
        float PlayerChargetemp = (FadeToBlackImage.color.a + (Time.deltaTime * (ChargeChange / 100)));
        Color tempColour = new Color(0, 0, 0, PlayerChargetemp);
        FadeToBlackImage.color = tempColour;
